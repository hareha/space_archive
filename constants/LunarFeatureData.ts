...
export const LUNAR_FEATURES: LunarFeature[] = [
  ...
  { id: 'FM-02', nameEn: 'Montes Apenninus', nameKr: '아펜닌 산맥', typeEn: 'Montes', typeKr: '산맥', lat: 18.9, lng: 3.7, diameterKm: 600, depthKm: null, areaKm2: null, angle: 45, widthKm: 100, description: '5,000m 이상의 고봉들이 부채꼴로 늘어선 장엄한 산맥으로 비의 바다 남동쪽 경계를 형성합니다.' },
  { id: 'FR-01', nameEn: 'Rupes Recta', nameKr: '직선의 벽', typeEn: 'Rupes', typeKr: '단층', lat: -22.1, lng: -7.8, diameterKm: 134, depthKm: 0.3, areaKm2: null, angle: 0, widthKm: 2, description: '구름의 바다에 위치한 거대 단층으로, 마치 인공적으로 칼로 그은 듯한 완벽한 직선 절벽입니다.' },
  ...
  { id: 'FV-01', nameEn: 'Vallis Alpes', nameKr: '알프스 계곡', typeEn: 'Vallis', typeKr: '계곡', lat: 48.5, lng: 3.2, diameterKm: 166, depthKm: 0.7, areaKm2: null, angle: 45, widthKm: 10, description: '알프스 산맥을 일직선으로 관통하는 거대한 협곡으로 과거 용암이 강처럼 흐르며 깎아 만든 지형입니다.' },
  ...
  { id: 'FV-02', nameEn: 'Vallis Schröteri', nameKr: '슈뢰터 계곡', typeEn: 'Vallis', typeKr: '계곡', lat: 26.2, lng: -50.8, diameterKm: 168, depthKm: 1.0, areaKm2: null, angle: 135, widthKm: 10, description: '아리스타르코스 고원에 위치한 달 최대의 구불구불한 용암 협곡으로 뱀이 지나간 선명한 자국 같습니다.' },
  ...
  { id: 'FR-02', nameEn: 'Rima Ariadaeus', nameKr: '아리아데우스 열구', typeEn: 'Rima', typeKr: '열구', lat: 6.4, lng: 17.3, diameterKm: 250, depthKm: 0.5, areaKm2: null, angle: 90, widthKm: 5, description: '고요의 바다 서쪽에서 시작되는 길고 깊은 직선형 협곡으로 달 지각이 양옆으로 갈라진 흔적입니다.' },
